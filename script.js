    ...
    fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${meal.idMeal}`)
        ...
        .then(data => {
            ...
            modalContent.innerHTML = `
                ...
                <img src="${detailedMeal.strMealThumb}" alt="${detailedMeal.strMeal}" style="max-width: 100%;">
                <p><strong>Ingredients:</strong> ${getIngredients(detailedMeal)}</p>
                <p><strong>Instructions:</strong> ${detailedMeal.strInstructions}</p>
                <p><strong>YouTube URL:</strong> <a href="${detailedMeal.strYoutube}" target="_blank">${detailedMeal.strYoutube}</a></p>
            `;
